...
/* =========================================================
   BRUGERENS PLAYLISTER PÅ PLAYLIST-SIDEN
========================================================= */

function renderUserPlaylistsOnPage() {
    ...
    savePlaylistButton.addEventListener(
        ...
        () => {
            ...
            if (!name) {
                ...
                alert(
                    "Skriv et navn til din playlist."
                );
